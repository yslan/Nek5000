...
#define crs_xyt_setup PREFIXED_NAME(crs_xyt_setup)
#define crs_xyt_solve PREFIXED_NAME(crs_xyt_solve)
#define crs_xyt_stats PREFIXED_NAME(crs_xyt_stats)
#define crs_xyt_free  PREFIXED_NAME(crs_xyt_free )
...
struct crs_data *crs_xyt_setup(
  uint n, const ulong *id,
  uint nz, const uint *Ai, const uint *Aj, const double *A,
  uint null_space, const struct comm *comm);
void crs_xyt_solve(double *x, struct crs_data *data, double *b);
void crs_xyt_stats(struct crs_data *data);
void crs_xyt_free(struct crs_data *data);
#endif
